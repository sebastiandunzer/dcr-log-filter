...
class Expression(object):
    ...
    def evaluate_expression(self, event, trace_data=None):
        ...
        if self.CheckDifferentEvent and trace_data is not None:
            ...
            if self.expression_reference_node == 'trace':
                expression_left_value = trace_data.Trace.TraceData.get(self.expression_left).get_value()
        ...
        elif self.expression_left not in event.Attributes and self.expression_right == '':
